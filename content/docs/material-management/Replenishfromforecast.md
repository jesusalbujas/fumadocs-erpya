...
![image](/docs-assets/8c1d321a-5c03-44e2-9360-6ea3e8ffa493.png)

- Seleccione la opción **Procesar Reabastecimiento(Basado en Pronóstico)**
  
![image](/docs-assets/8fcd0068-2107-4972-8c60-fc6c1c1257d4.png)

- A continuación veremos la siguiente pantalla
  
![image](/docs-assets/22b21d38-41be-4e03-8f87-c737fe4fe385.png)

- Indique el **Calendario operacional**, se refiere a la definición del calendario de planificación productiva en una empresa.
  
![image](/docs-assets/f09a52f9-bf73-46f2-8910-7a723fc36192.png)
...
![image](/docs-assets/455ce076-d9aa-465a-a407-c630346af083.png)
...
![image](/docs-assets/a0b176f7-9927-4148-b9a5-ca1f6ba5dce7.png)

- A continuación veremos la siguiente pantalla

![image](/docs-assets/5cc05828-8012-4567-a625-f3fc165de38f.png)

- Proceda a seleccionar el plan de reabastecimiento para generar la estimación del reabastecimiento.

![image](/docs-assets/3ff2317f-6a71-43e3-b6d6-55dfb252ec97.png)

- Seleccionar el producto en caso de querer filtrar el producto a reabastecer.

![image](/docs-assets/080299ba-8ead-4cf3-bc29-f60c877f1e28.png)

- Seleccionar **Comenzar la búsqueda**

![image](/docs-assets/44031afc-f67c-44d5-b923-364140e67a66.png)

- Seleccionar los productos a reabastecer.
- Seleccionar el tipo de documento para la requisición.

![image](/docs-assets/44110194-ed3f-404a-9102-d4a742408d5e.png)

- Seleccionar la fecha para la requisición.

![image](/docs-assets/7e157375-1440-4e25-b73c-2a275c2fad5e.png)

- Seleccionar la Lista de Precios para la requisición.

![image](/docs-assets/cc269959-f3b7-42bb-a574-b53a10637897.png)

- Seleccionar el almacén para la requisición.

![image](/docs-assets/6edd3ff2-1056-492c-83ed-8b2a4ec76c26.png)

- Seleccionar el proyecto para la requisición.

![image](/docs-assets/43165140-0492-451e-aed3-5b6e17933064.png)

- Seleccionar la Actividad para la requisición

![image](/docs-assets/fb059eb0-4307-424e-835f-74d3d9dbf6cc.png)


- Seleccionar la Organización para la requisición.

![image](/docs-assets/280e233c-1e88-4df5-bf12-3bf31c595f99.png)

- Seleccionar el centro de costo para la requisición.

![image](/docs-assets/d4fbfa83-fcf7-4578-af78-cc29d08a5b2c.png)

- Seleccionar la acción de documento para la requisición.

![image](/docs-assets/fa5b7933-0741-4994-bb3d-ea09dd60b015.png)

- Seleccionar la opción **OK**

![image](/docs-assets/af6e3a4b-0137-4dbd-9d58-787e36ca4c97.png)
