...
- [Haz click aquí](/docs/data-importation/payroll-importation/comprehensive-salary/export-files/README/)
...
![seleccion-del-archivo](/docs-assets/imgur-2PKPqlh.png)

![formato](/docs-assets/imgur-Cvct8yZ.png)