...
- [Haz click aquí](/docs/data-importation/payroll-importation/normal-monthly-salary/export-files/README/)
...
![seleccion-del-archivo](/docs-assets/imgur-095ZnJh.png)

![formato](/docs-assets/imgur-gnjuIxj.png)