...
**Fecha de Liberación:** 2023-08-15

## Novedades

- Se agrega parametro de proceso Re-Contabilizar en Proceso Generar Transacciones de Costos

- Se Quita Chequeo de Periodo en Motor de Costo Facturacion Promedio
...
- Add Parameter for Reset Accounting on Generate Cost Detail Process

- Remove Check Open Period on Average Invoice Costing Method
...
- Aplicar XML's:
  - 07850_Add_Reset_Account_Parameter_on_Generate_Cost_Process.xml
