...
**Fecha de Liberación:** 2023-09-08

## Novedades

- Se agrega mejora para permitir definir cálculos de peso acondicionado dependiendo del almcacén de recepción y Socio de Negocio

## Contexto

- Cálculo de Peso Acondicionado en Materia Prima
...
- Add support to Claculation based on warehouse and business partner
- Add support to Formula: 
- `org.erpya.lve.farming.engine.Corn_COVENIN_1935_2017_v1`
...
- Aplicar binario de la aplicación
  - Aplicar XML's:
    - 08100_FAP_Add_Warehouse_for_Filter_Values.xml
    - 08110_FAP_Add_Reference_to_Weight_Conditioning.xml
