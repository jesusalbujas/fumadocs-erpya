...
**Fecha de Liberación:hourglass_flowing_sand::** 2023-09-13

## Novedades

- Se corrige error en tiempo de ejecución cuando se completa una producción generada sin una orden de producción
...
- Fixed error with NPE for production created without production batch
