...
**Fecha de Liberación:hourglass_flowing_sand::** 2023-10-02

## Novedades

- Se mejora fórmula para el cálculo de peso acondicionado con base en la norma COVENIN 1935-2017.

## Contexto

- Cálculo de Peso acondicionado
- Registro de Peso
...
- Fixed error with Corn formula based on COVENIN
