...
**Fecha de Liberación:hourglass_flowing_sand::** 2023-09-21

## Novedades

- Se Corrige contabilidad de Costos Adicionales de facturas creadas en monedas distintas a la moneda del esquema contable

## Contexto

- Contabilidad de Factura de CxP

## Enlaces Relacionados

- [Error en la contabilización de costos Adicionales #484](https://github.com/erpcya/Control-PROSEIN/issues/484)
...
- CST-STD:
  - Fix Doc Invoiced with Landed Cost Allocations
