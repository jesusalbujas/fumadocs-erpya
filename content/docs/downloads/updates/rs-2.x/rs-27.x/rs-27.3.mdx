...
- CST-STD:
  ...
  - Fixed error with Tax calculation for Sales Orders: [https://github.com/erpcya/Control-MIGO/issues/5](https://github.com/erpcya/Control-MIGO/issues/5)
  - Add support to express receipt based on quantities: [https://github.com/erpcya/Control-CRIOLLITO/issues/2](https://github.com/erpcya/Control-CRIOLLITO/issues/2)
