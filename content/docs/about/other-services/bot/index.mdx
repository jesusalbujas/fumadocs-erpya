...
- [Configuración en ADempiere](/docs/about/other-services/bot/configuration-in-adempiere)

- [Interfaz del Bot](/docs/about/other-services/bot/use)

- [Soporte en Bot](/docs/about/other-services/bot/bot-support)
